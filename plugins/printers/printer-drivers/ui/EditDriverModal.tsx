                        ...
                        <div className="p-4 border-t border-slate-800 bg-slate-900/50 backdrop-blur-sm flex justify-between items-center">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className="px-6 py-2.5 rounded-lg bg-amber-500 text-black text-sm font-bold hover:bg-amber-400 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-amber-500/20 active:scale-95 transition-all flex items-center gap-2"
                                >
                                    {isSaving ? (
                                        <>Updating...</>
                                    ) : (
